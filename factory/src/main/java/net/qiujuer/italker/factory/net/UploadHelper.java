...
public class UploadHelper {
    ...
    // 上传的仓库名
    private static final String BUCKET_NAME = "italker-zfw";

    private static final String accessKeyId="LTAI5Fvv5pfjuEB8";

    private static final String accessKeySecret="zIg3CRLfDMNj4BA7DB8sPgy9LYKcbL";
